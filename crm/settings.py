...
# Email defaults for dev (console backend already set)
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "dev@example.com")
ADMIN_EMAIL = os.environ.get("ADMIN_EMAIL", "admin@example.com")

# Celery: avoid KeyError if you’re not running Celery yet
CELERY_BROKER_URL = os.environ.get("CELERY_BROKER_URL", "memory://")
CELERY_RESULT_BACKEND = os.environ.get("CELERY_RESULT_BACKEND", "cache+memory://")

# Swagger / domain defaults
DOMAIN_NAME = os.environ.get("DOMAIN_NAME", "localhost")
SWAGGER_ROOT_URL = os.environ.get("SWAGGER_ROOT_URL", "/")
...
if all(os.environ.get(k) for k in ("DBNAME", "DBUSER", "DBPASSWORD", "DBHOST", "DBPORT")):
    DATABASES = {
        "default": {
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-relpy@example.com")
...
if ENV_TYPE == "prod":
    ...
    # No manifest in dev, so you don’t need collectstatic
...
SWAGGER_ROOT_URL = os.getenv("SWAGGER_ROOT_URL", "/")
